...
export default function IntermittentFastingPage() {
  const breadcrumbItems = [
    ...
    { label: "Intermittent Fasting", href: "/plans/intermittent-fasting" },
  ]

  const tocItems = [
    { id: "understanding", label: "What is IF?" },
    { id: "schedules", label: "Fasting Schedules" },
  ...
  const faqs = [
    {
      ...
      answer: "Not necessarily. In fact, fasting increases Human Growth Hormone (HGH) which protects muscle. However, you MUST eat enough protein (0.8-1g per pound of bodyweight) during your eating window and perform resistance training. If you under-eat protein, you will lose muscle regardless of fasting."
    },
    {
      question: "Can I drink coffee with milk during my fast?",
      answer: "Technically, no. Milk, cream, and sugar contain calories and will break your fast (and stop autophagy). For best results, stick to black coffee, plain tea, or water. If you absolutely must, a 'splash' (less than 1 tbsp) of milk might not destroy weight loss results but it does technically break the fast."
    },
    {
      question: "Is intermittent fasting safe for women?",
      answer: "Yes, but women should be more careful. Prolonged fasting can sometimes disrupt hormones (cortisol, reproductive hormones). It is often recommended for women to start with a gentler window (14:10) and avoid strict fasting during the week before menstruation when the body needs more energy. Listen to your body!"
    },
    {
      question: "I get terrible headaches when I fast. What should I do?",
      answer: "Fasting headaches are usually due to dehydration or electrolyte imbalance, not hunger. When insulin drops, kidneys flush out sodium. Add a pinch of sea salt to your water or take an electrolyte supplement (with no sugar) during your fast to prevent headaches and dizziness."
    },
    {
      question: "Can I take supplements while fasting?",
      answer: "Yes, but avoid gummy vitamins (sugar) or fat-soluble vitamins (A, D, E, K) or Omega-3s on an empty stomach as they absorb better with food. Water-soluble vitamins (B, C) and minerals (Magnetism, Zinc) are fine to take during the fast."
    }
  ]
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-20">
      ...
      {/* Fasting Schedules */}
      <section id="schedules" className="py-16 bg-gray-50 scroll-mt-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
