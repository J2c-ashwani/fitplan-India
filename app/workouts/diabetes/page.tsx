        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-white mb-8 border-l-4 border-blue-300 pl-4 text-left bg-white/10 p-4 rounded-r-lg shadow-md leading-relaxed">
              <strong>The Short Answer:</strong> A combination of moderate aerobic exercise (like brisk walking) and resistance training is the gold standard for diabetics. Walking for just 15 minutes after a meal creates an immediate drop in blood glucose spikes. Adding strength training 2-3 times a week builds muscle, which acts as a "sugar sink" to dramatically improve your body's insulin sensitivity for up to 48 hours.
            </p>
